...
public class SigninCheck {
	...
	public void checkRegisterPage() throws IOException {
		...
		List<String> expectedFields = Arrays.asList("ffirstname", "flastname", "femail", "fpassword", "fconfirmPassword");
			//  - it is reachable
		try {
	...
	public void checkSigninServlet() throws IOException {
		...
		data.put("ffirstname", "Test");
		data.put("flastname", "Test");
		data.put("femail", userMail2);
		data.put("fpassword", "test");
		data.put("fconfirmPassword", "test");
	...
	private void doMissingFieldsRequests(MissingFieldHandler cb) {
		List<String> expectedFields = Arrays.asList("ffirstname", "flastname", "femail","fpassword");
	...
	public void checkSigninServlet_checkMissingParam() throws IOException {
		...
		doMissingFieldsRequests( (field, code, content, err) -> {
			...
			switch ( field ) {
			case "firstname":
				errorMessage = msg.contains("ffirstname") || msg.contains("prénom");
				break;
			case "lastname":
				errorMessage = msg.contains("flastname") || msg.contains("nom");
				break;
			case "email":
				errorMessage = msg.contains("femail");
				break;
			case "password":
				errorMessage = msg.contains("fpassword") || msg.contains("mot de passe");
				break;
			}
		...
		data.put("femail", userMail2);
		data.put("fpassword", "test");
		data.put("fconfirmPassword", "testError");
	...
	public void checkSigninServlet_ErrorOnExistingUser() throws IOException {
		...
		data.put("ffirstname", "Test");
		data.put("flastname", "Test");
		data.put("femail", "mark.zuckerberg@facebook.com");
		data.put("fpassword", "test");
