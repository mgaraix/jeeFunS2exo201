...
public interface UserDao {
	  ...
	  //  chemin absolu vers la resource db
	public static final String MYAPP ="exo201";
	public static final String SQLBDD= "C:\\MesAppli\\TOMCAT9\\apache-tomcat-9.0.44\\webapps\\"+
                                        MYAPP + "\\WEB-INF\\sql\\";
	 ...
	 * 
	 * @return liste des user, null si non trouvé
	 */
